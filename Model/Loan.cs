...
namespace StudentLibrary.Model
{
    public class Loan
    {
        ...
        public Book Book { get; set; } //Навигационное свойство для связи с моделью Book. Позволяет получить информацию о книге, которая была выдана.
        ...
        public Student Student { get; set; } // Навигационное свойство для связи с моделью Student. Позволяет получить информацию о студенте, который взял книгу.
